...
(function (window, document, undefined) {
    ...
    var log = function (msg) {
        ...
        removeElements = function (remove) {// function to remove elements, input as arrays
        ...
        scriptLoader = function (script, func) {// script onload function to provide support for IE as well
    ...
    window.Feedback = function (options) {
        ...
        options.pages = [
            new window.Feedback.Form(options.fields || [
                    {
                        type: "textarea",
                        name: "Issue",
                        label: "Description",
        ...
        var button,
            ...
            returnMethods = {
                ...
                open: function () {
                    ...
                    modalHeader.className = "modal-header feedback-header";

                    modalBody.className = "modal-body feedback-body";
                    ...
                    nextButton.className = "btn btn-sm btn-default feedback-btn";
                    ...
                    modalFooter.className = "modal-footer feedback-footer";
                ...
                send: function (adapter) {
                    ...
                    adapter.send(data, function (success, res) {
                        if (success) {
                            res = JSON.parse(res);
                            toastr.success(options.messageSuccess);
                            location.reload();
                            //emptyElements( modalBody );
                            ...
                            toastr.error(options.messageError);
                            location.reload();
                        }
                    });
        ...
        for (; i < len; i++) {
            ...
            switch (item.type) {
                case "dropdown":
                    ...
                    item.element.className = "form-control select2me";
                    for (var optionIndex = 0; optionIndex < item.selects.length; optionIndex++) {
                        var option = document.createElement('option');
                        option.text = option.value = item.selects[optionIndex];
                        item.element.add(option, optionIndex);
                    }
                ...
                case "textarea":
                    ...
                    item.element.className = "form-control";
                    this.dom.appendChild(item.element);
                    break;
            }
        }
